...
def create_lyric_video():
    ...
    full_video = request.form.get(
        "full_video", type=lambda x: x.lower() == "true", default=False
    )
    ...
    generate_lyric_prompts = request.form.get(
        "generate_lyric_prompts", type=lambda x: x.lower() == "true", default=True
    )
    use_local_generation = request.form.get(
        "useLocalGeneration", type=lambda x: x.lower() == "true", default=True
    )
    video_prompt_style = request.form.get(
        "video_prompt_style", default=VIDEO_PROMPT_STYLE
    )
